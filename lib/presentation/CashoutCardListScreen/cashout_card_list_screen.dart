                                        ...
                                        child: Center(
                                          child: CashoutCreditCardWidget(
                                              cardHolderName: cardListController
                                                  ...
                                                  .toString(),
                                              cardType:
                                                  cardListController.mainCardList.value[cardListController.selectIndex!].cardType
                                                      .toString(),
                                              hPadding: 65,
                                              cardNumber:
                                                  cardListController.mainCardList.value[cardListController.selectIndex!].cardNumber
                                                      .toString(),
                                      ...
                                      itemBuilder:
                                        ...
                                        return Obx(
                                          () => Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                cardListController.selectIndex =
                                                    index;
                                                cardListController
                                                    .selectCreditCard();
                                              },
