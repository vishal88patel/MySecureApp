                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => QRViewExample2()),
                            );
                          },
                          child: Padding(
                            padding: const EdgeInsets.all(4.0),
                            child: Image.asset('asset/scan_icon.png',color: ColorConstant.primaryWhite,width: getHorizontalSize(34),),
                          ),
                        )
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: InkWell(
                            onTap: () {
                              Get.toNamed(AppRoutes.cashOutAmountNumPadScreen,
                                  arguments: {
                                    'WALLET_BALANCE':
                                        transactionController.balance.value,
                                  });
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                if (index ==
                                    transactionController
                                        .transactionList.value.length) {
                                  if (transactionController.pageNumber.value >=
                                      transactionController.lastPage.value) {
                                    return Container();
                                  } else {
                                    return Padding(
