    ...
    return Scaffold(
        ...
        body: Stack(
          ...
          children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Text(
                          requestMoneyScreenController.name.value,
                      ...
                      Obx(
                        () => Text(
                          requestMoneyScreenController.date.value,
                          style: AppStyle.textStyleDMSANS.copyWith(
            ...
            Obx(
              () => AnimatedContainer(
                height: requestMoneyScreenController.dropHeight.value,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AnimatedContainer(
                        duration: Duration(milliseconds: 300),
                        height: requestMoneyScreenController.animContainerHeighr.value,
                        child: Accordion(
                          paddingListBottom: 0,
                          ...
                          children: [
                           /* AccordionSection(
                            ...
                            AccordionSection(
                              ...
                              contentBorderRadius: 12,
                              contentBorderColor: Colors.white,
                              isOpen:  requestMoneyScreenController.isFirstOpen.value,
                              leftIcon: Padding(
                                padding: const EdgeInsets.symmetric(
                                    vertical: 8.0, horizontal: 12),
                                child: Container(
                              ...
                              ColorConstant.primaryAppTextF1,
                              header: Container(
                                  child: Text(requestMoneyScreenController.selectedMethod.value,
                                      style: AppStyle.DmSansFont.copyWith(
                                          color: ColorConstant.primaryBlack,
                                          fontSize: getFontSize(16),
                                          fontWeight: FontWeight.bold))),
                              content: Column(
                                children: [
                                  AccordionSection(
                                    ...
                                    contentBorderWidth: 1,
                                    onOpenSection: () {
                                      requestMoneyScreenController.onTaoOfItem("Wallet");
                                    },
                                    onCloseSection: () {
                                      requestMoneyScreenController.onTaoOfItem("Wallet");
                                    },
                                  ...
                                  AccordionSection(
                                    ...
                                    contentBorderWidth: 1,
                                    onOpenSection: () {
                                      requestMoneyScreenController.onTaoOfItem("Cash Card");
                                    },
                                    onCloseSection: () {
                                      requestMoneyScreenController.onTaoOfItem("Cash Card");                                    },
                                  ),
                              ...
                              contentBorderWidth: 1,
                              onOpenSection: () {
                                requestMoneyScreenController.onChangeOfExpansonTile();
                              },
                              onCloseSection: () {
                                requestMoneyScreenController.onChangeOfExpansonTile();
                              },
                      ...
                      AppElevatedButton(
                        ...
                        radius: 16,
                        onPressed: () {
                          requestMoneyScreenController.onTapOfprocessToPay();
                        },
                      ),
