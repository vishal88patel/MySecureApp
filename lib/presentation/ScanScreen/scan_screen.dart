    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            AiBarcodeScanner(
              showOverlay: false,
              controller: scanController.controller,
              onScan: (String value) {
                debugPrint(value);
                scanController.qrCodeResult.value=value.toString();
                print("UdId"+value.toString());
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(color: ColorConstant.primaryDarkGreen,width: 4)
                  ),
                ),
              ),
            ),
