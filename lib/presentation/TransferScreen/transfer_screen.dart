            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  padding: EdgeInsets.symmetric(vertical: getVerticalSize(40),
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Total Balance",style: AppStyle.DmSansFont
                      ...
                      Container(
                        ...
                        child: Icon(Icons.add,color: ColorConstant.buttonGreen,),
                      )
                    ],
                  ),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Image.asset('asset/icons/scan_icon.png',
                                height: getVerticalSize(60),),
                              SizedBox(
                                height: getVerticalSize(10),
                              ),
                              Text("Scan and \nPay",style: AppStyle.DmSansFont
                                  .copyWith(color: ColorConstant.primaryBlack,
                                  fontWeight: FontWeight.w700,fontSize: getFontSize(16)),),
                              SizedBox(
                                height: getVerticalSize(20),
                              ),
                              Text("To acc to acc",style: AppStyle.DmSansFont
